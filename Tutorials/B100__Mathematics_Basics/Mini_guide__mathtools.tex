...
\end{lstlisting}
	...
	The \enquote{mathtools} package offers starred versions of the \texttt{matrix} environments which allow to pass an optional argument to specify the alignment inside the matrix's columns.
